            ...
            switch (randomNum) {
            	case 1:{
            		seleccion = JOptionPane.showOptionDialog( 
                			   b1, "El número cinco mil cuatrocientos treinta y uno, se escribe", 
                ...
                case 5:{
                	seleccion = JOptionPane.showOptionDialog( 
               			   b5, "El poeta colombiano Rafael Pombo escritor de la pobre viejecita, nació en el año 1833 y murió en 1912. ¿De cuantos años murió el poeta?", 
               			   "Selector de opciones",
               			   JOptionPane.YES_NO_CANCEL_OPTION,
               			   JOptionPane.QUESTION_MESSAGE, 
                ...
                case 8:{
                	seleccion = JOptionPane.showOptionDialog( 
             			   b6, "El número mil cuatrocientos veintiséis, se escribe", 
             			   "Selector de opciones",
             			   JOptionPane.YES_NO_CANCEL_OPTION,
             			   JOptionPane.QUESTION_MESSAGE, 
                ...
                case 10:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   b9, "El número siete mil veintitrés se escribe", 
              			   "Selector de opciones",
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
                ...
                case 11:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   ...
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
              			   null, new Object[] { "A. Leticia","B. Arauca","C. Neiva","D. Bogotá" },   
              			   "opcion 1");
                 	if (seleccion==0) {
                 		encontro = true;
                 	}
                ...
                case 12:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   ...
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
              			   null, new Object[] { "A. Pereira","B. Neiva","C. Cúcuta","D. Medellín" },   
              			   "opcion 1");
                 	if (seleccion==3) {
                 		encontro = true;
                 	}
                ...
                case 13:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   b9, "La Capital del Departamento de Boyacá es:", 
              			   "Selector de opciones",
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
              			   null, new Object[] { "A. Florencia","B. Manizales","C. Tunja","D. Medellín " },   
              			   "opcion 1");
                 	if (seleccion==2) {
                 		encontro = true;
                 	}
                ...
                case 14:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   ...
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
              			   null, new Object[] { "A. Florencia","B. Manizales","C. Tunja","D. Montería " },   
              			   "opcion 1");
                 	if (seleccion==1) {
                 		encontro = true;
                 	}
                ...
                case 15:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   ...
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
              			   null, new Object[] { "A. Yopal","B. Bogotá","C. Inírida","D. Cúcuta" },   
              			   "opcion 1");
                 	if (seleccion==1) {
                 		encontro = true;
                 	}
                ...
                case 16:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   ...
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
              			   null, new Object[] { "A. Cartagena","B. Bogotá","C. Tunja","D. Valledupar" },   
              			   "opcion 1");
                 	if (seleccion==3) {
                 		encontro = true;
                 	}
                ...
                case 17:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   ...
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
              			   null, new Object[] { "A. Villavicencio","B. Bogotá","C. Inírida","D. Riohacha" },   
              			   "opcion 1");
                 	if (seleccion==0) {
                 		encontro = true;
                 	}
                ...
                case 18:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   b9, "La Capital del Departamento de Nariño es:", 
              			   "Selector de opciones",
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
              			   null, new Object[] { "A. Yopal","B. Pasto","C. Inírida","D. Montería " },   
              			   "opcion 1");
                 	if (seleccion==1) {
                 		encontro = true;
                 	}
                ...
                case 19:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   b9, "La Capital del Departamento de San Andrés y Providencia es:", 
              			   "Selector de opciones",
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
              			   null, new Object[] { "A. San Andrés","B. Montería","C. Florencia","D. Tunja  " },   
              			   "opcion 1");
                 	if (seleccion==0) {
                 		encontro = true;
                 	}
                ...
                case 20:{
                	seleccion = JOptionPane.showOptionDialog( 
              			   ...
              			   JOptionPane.YES_NO_CANCEL_OPTION,
              			   JOptionPane.QUESTION_MESSAGE, 
              			   null, new Object[] { "A. Medellín","B. Pereira","C. Arauca","D. Bucaramanga " },   
              			   "opcion 1");
                 	if (seleccion==3) {
                 		encontro = true;
                 	}
